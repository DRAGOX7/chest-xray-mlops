...
train_dataset = datasets.ImageFolder(
    root=f"{TARGET_DIR}/train", transform=train_transform
)

val_dataset = datasets.ImageFolder(
    root=f"{TARGET_DIR}/val", transform=val_test_transform
)

test_dataset = datasets.ImageFolder(
    root=f"{TARGET_DIR}/test", transform=val_test_transform
)
...
train_dataset = datasets.ImageFolder(
    os.path.join(TARGET_DIR, "train"), transform=train_transform
)
val_dataset = datasets.ImageFolder(
    os.path.join(TARGET_DIR, "val"), transform=val_transform
)
